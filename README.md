...
### Copyright
The license used in this repository is MIT license. Plagiarism is prohibited.

### Feature Table
Below is an overview of supported functionalities for specific modules:
...
md-0003-beta No longer dependent on API
